...
Livox ROS Driver 2 is the 2nd-generation ROS2 driver package used to connect LiDAR products produced by Livox.
...
ROS2 launch files are in the `launch_ROS2` directory. Different launch files are used in different scenarios:
...
| xfer_format  | Set pointcloud format<br>0 -- Livox pointcloud2 (PointXYZRTLT) format<br>1 -- Livox customized pointcloud format | 0       |
