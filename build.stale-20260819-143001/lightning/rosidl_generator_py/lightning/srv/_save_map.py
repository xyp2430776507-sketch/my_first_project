    ...
    def response(self, value):
        if __debug__:
            ...
            assert value >= 0 and value < 4294967296, \
                "The 'response' field must be an unsigned integer in [0, 4294967295]"
...
class Metaclass_SaveMap(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from lightning.srv import _save_map
...
class SaveMap(metaclass=Metaclass_SaveMap):
    from lightning.srv._save_map import SaveMap_Request as Request
    from lightning.srv._save_map import SaveMap_Response as Response
