...
class SlamSystem {
   ...
   private:
    ...
    /// Publish online 3D SLAM products for RViz without changing LIO math.
    void PublishRvizFrame(const builtin_interfaces::msg::Time& stamp);
    void PublishRvizMap(const builtin_interfaces::msg::Time& stamp);
    ...
    rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr rviz_map_pub_ = nullptr;
    rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr rviz_scan_pub_ = nullptr;
    rclcpp::Publisher<nav_msgs::msg::Path>::SharedPtr rviz_path_pub_ = nullptr;
    rclcpp::Publisher<nav_msgs::msg::Odometry>::SharedPtr rviz_odom_pub_ = nullptr;
    std::shared_ptr<tf2_ros::TransformBroadcaster> rviz_tf_broadcaster_ = nullptr;
};
}  // namespace lightning
